...
namespace WarcraftPlugin.Classes
{
    public class Rapscallion : WarcraftClass
    {
        ...
        private void Ultimate()
        {
            ...
            if (UltimateToggle || !IsAbilityReady(3))
                return;
            ...
            WarcraftPlugin.Instance.AddTimer(2f, () =>
            {
                ...
                var innerServices = new CCSPlayer_ItemServices(Player.PlayerPawn.Value.ItemServices.Handle);

                SetMoveType(Player.PlayerPawn.Value, MoveType_t.MOVETYPE_WALK);
                Player.PlayerPawn.Value.Teleport(null, null, new Vector(0, 0, 0));
                UltimateToggle = false;
    ...
    : base(owner, duration)
        ...
        internal class ChargeWhileMovingEffect : WarcraftEffect
        {
            ...
            private readonly int _chargeRate;
        ...
        : base(owner, duration: 9999f, destroyOnDeath: true, destroyOnRoundEnd: true, onTickInterval: 1.8f)
            {
                _chargeRate = (int)Math.Pow(2, abilityLevel - 1);
            }
            ...
            private void CheckForMovementAndAddCharge()
            {
                ...
                _chargeStacks = Math.Min(_chargeStacks + _chargeRate, _maxCharge);

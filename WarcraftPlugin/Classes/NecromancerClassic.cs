...
namespace WarcraftPlugin.Classes
{
    internal class NecromancerClassic : WarcraftClass
    {
        ...
        [
            ...
            new WarcraftAbility("Unholy Frenzy", "25% chance to deal double damage."),
        ...
        private void PlayerHurtOther(EventPlayerHurtOther hurt)
        {
            ...
            if (WarcraftPlayer.GetAbilityLevel(1) > 0 && Random.Shared.Next(100) < 25)
            {
                hurt.AddBonusDamage(hurt.DmgHealth, abilityName: GetAbility(1).DisplayName);
            }
        }

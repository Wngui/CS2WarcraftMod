...
namespace WarcraftPlugin.Helpers
{
    ...
    public static class Warcraft
    {
        ...
        private class StunEffect(CCSPlayerController owner, CCSPlayerController attacker, string abilityName, float duration) : WarcraftEffect(owner, duration)
        {
            private float _originalSpeed;
            private float _originalModifier;
            private readonly CCSPlayerController _attacker = attacker;
            private readonly string _abilityName = abilityName;
